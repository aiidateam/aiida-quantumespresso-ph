...
project = 'aiida-quantumespresso-ph'
...
# autoapi_ignore = [filepath_src / 'aiida_quantumespresso_ph' / '*cli*']
...
exclude_patterns = [
    '**.ipynb_checkpoints',
    'reference/api/auto/aiida_quantumespresso_ph/index.rst',
]
...
html_theme_options = {
    'repository_url': 'https://github.com/aiidateam/aiida-quantumespresso-ph',
    'github_url': 'https://github.com/aiidateam/aiida-quantumespresso-ph',
    'twitter_url': 'https://twitter.com/aiidateam',
    'use_edit_page_button': True,
    'navigation_with_keys': False,
    'logo': {
        'text': 'AiiDA Quantum ESPRESSO for PHonon',
...
html_context = {
    ...
    'github_repo': 'aiida-quantumespresso-ph',
    'github_version': 'main',
...
html_use_opensearch = 'http://aiida-quantumespresso-ph.readthedocs.io'
...
htmlhelp_basename = 'aiida-quantumespresso-phdoc'
...
nitpick_ignore_regex = [
    ...
    (r'py:class', r'Field(\[.*\])?'),
    (r'py:.*', r'aiida_quantumespresso_ph.*'),
    (r'py:.*', r'aiida.*'),
]
nitpick_ignore = [
    ('py:class', 't.IO'),
